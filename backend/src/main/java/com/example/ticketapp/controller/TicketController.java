...
//    public ResponseEntity<TicketEntity> updateTicketStatus(@PathVariable Long id, @RequestParam boolean newStatus) {
//        TicketEntity updatedTicket = ticketService.updateTicketStatus(id, newStatus);
